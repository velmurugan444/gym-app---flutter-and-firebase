...
class ExpertFoodScheduleUploadScreen extends StatefulWidget {
  final String monday;
  ...
  final String sunday;
  ExpertFoodScheduleUploadScreen({
    this.monday,
    this.tuesday,
    this.wednesday,
    this.thursday,
  ...
  @override
  _ExpertFoodScheduleUploadScreenState createState() =>
      _ExpertFoodScheduleUploadScreenState();
}

class _ExpertFoodScheduleUploadScreenState
    extends State<ExpertFoodScheduleUploadScreen> {
