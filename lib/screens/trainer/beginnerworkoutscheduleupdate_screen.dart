...
class BeginnerWorkoutScheduleUploadScreen extends StatefulWidget {
  final String monday;
  ...
  final String sunday;
  BeginnerWorkoutScheduleUploadScreen({
    this.monday,
    this.tuesday,
    this.wednesday,
    this.thursday,
  ...
  @override
  _BeginnerWorkoutScheduleUploadScreenState createState() =>
      _BeginnerWorkoutScheduleUploadScreenState();
}

class _BeginnerWorkoutScheduleUploadScreenState
    extends State<BeginnerWorkoutScheduleUploadScreen> {
