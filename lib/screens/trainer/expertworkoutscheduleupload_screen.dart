...
class ExpertWorkoutScheduleUploadScreen extends StatefulWidget {
  final String monday;
  ...
  final String sunday;
  ExpertWorkoutScheduleUploadScreen({
    this.monday,
    this.tuesday,
    this.wednesday,
    this.thursday,
  ...
  @override
  _ExpertWorkoutScheduleUploadScreenState createState() =>
      _ExpertWorkoutScheduleUploadScreenState();
}

class _ExpertWorkoutScheduleUploadScreenState
    extends State<ExpertWorkoutScheduleUploadScreen> {
            ...
            RaisedButton(
              onPressed: () async {
                ...
                String successfulMessage =
                    "Expert schedule was successfully updated";
