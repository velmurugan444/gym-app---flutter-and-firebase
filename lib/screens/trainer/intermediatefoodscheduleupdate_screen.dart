...
class IntermediateFoodScheduleUploadScreen extends StatefulWidget {
  final String monday;
  ...
  final String sunday;
  IntermediateFoodScheduleUploadScreen({
    this.monday,
    this.tuesday,
    this.wednesday,
    this.thursday,
  ...
  @override
  _IntermediateFoodScheduleUploadScreenState createState() =>
      _IntermediateFoodScheduleUploadScreenState();
}

class _IntermediateFoodScheduleUploadScreenState
    extends State<IntermediateFoodScheduleUploadScreen> {
